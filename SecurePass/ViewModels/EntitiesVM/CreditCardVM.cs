...
namespace SecurePass.ViewModels.EntitiesVM
{
    internal class CreditCardVM :SecureObjectVM
    {
        ...
        public CreditCardVM(CreditCard creditCard) : base(creditCard.Id,creditCard.ImageId,creditCard.CategoryId,creditCard.UserId,creditCard.Title,creditCard.OwnerName, creditCard.IsFavorit)
        {
